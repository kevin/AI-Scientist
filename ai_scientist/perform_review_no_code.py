...
reviewer_system_prompt_base = (
    "You are a lead researcher who is reviewing a proposal for a new research project."
    "Be critical and cautious in your decision."
)

reviewer_system_prompt_neg = (
    reviewer_system_prompt_base
    + "If a proposal is bad or you are unsure, give it bad scores and reject it."
)
reviewer_system_prompt_pos = (
    reviewer_system_prompt_base
    + "If a proposal is good or you are unsure, give it good scores and accept it."
)
...
review_form = (
    """
## Review Form
Below is a description of the questions you will be asked on the review form for each research proposal and some guidelines on what to consider when answering these questions.
When writing your review, please keep in mind that after decisions have been made, reviews and meta-reviews of accepted proposals and opted-in rejected proposals will be made public. 

1. Summary: Briefly summarize the proposal and its intended contributions. This is not the place to critique the paper; the authors should generally agree with a well-written summary.
  ...
  - Quality: Is the proposed methodology technically sound? Are the research questions well formulated? Is the proposed approach appropriate for addressing these questions? Are the authors careful and honest about evaluating both the strengths and weaknesses of their work
  ...
  - Significance: Are the potential results important? Are others (researchers or practitioners) likely to use the ideas or build on them? Does the submission address a difficult task in a better way than previous work? Does it advance the state of the art in a demonstrable way? Does it provide unique data, unique conclusions about existing data, or a unique theoretical or experimental approach?
...
4. Ethical concerns: If there are ethical issues with this research proposal, please flag the paper for an ethics review.

5. Soundness: Please assign the paper a numerical rating on the following scale to indicate the soundness of the proposed methodology and research plan.
  4: excellent
  3: good
  2: fair
  1: poor
...
7. Contribution: Please assign the paper a numerical rating on the following scale to indicate the quality of the overall potential contribution if the research succeeds as proposed.
  4: excellent
  3: good
  2: fair
  1: poor
...
def perform_review(
    ...
    review_instruction_form=review_form,
):
...
meta_reviewer_system_prompt = """You are a Principal Investigator at a research center.
