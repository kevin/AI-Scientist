...
Your proposed investigation will consist of searching for existing published data and/or gathering new data with a study of your own to make a conclusion and support it.
Note that you are not actually doing the research yet, but producing a proposal explaining why the idea is important to investigate and with a detailed plan for the research and how to interpret the possible results.
...
novelty_system_msg = """You are an ambitious researcher who is looking to publish a paper that will contribute significantly to the field.
You have an idea and you want to check if it is novel or not. I.e., not overlapping significantly with existing literature or already well explored.
Be a harsh critic for novelty, ensure there is a sufficient contribution in the idea for a new paper.
